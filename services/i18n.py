...
TRANSLATIONS = {
    "en": {
        ...
        "analyzing_link_slow": "Still working… some links can take a bit longer.",
        "extract_failed": (
        ...
        "formats_video_header": "Video formats:",
        "formats_audio_header": "Audio:",
        "audio_only": "Only audio is available for this link.",
        "unknown": "Unknown",
        "expired_selection": "This selection has expired. Send the link again.",
        "original_link_not_found": "I couldn't find your original link message. Please send the link again.",
        "no_url_found": "No valid link found in that message.",
        "send_link_example": "Example: {example}",
        "rate_limit_exceeded": "Rate limit exceeded. Max 5 downloads per minute.",
        "rate_limit_exceeded_wait": "Rate limit exceeded. Please wait about {seconds}s and try again.",
        ...
        "done_ready": "✅ Done. Send another link anytime.",
        "audio_mp3": "Audio (MP3)",
        "best_quality": "⭐ Best (recommended)",
    ...
    "uz": {
        ...
        "analyzing_link_slow": "Hali ishlayapman… ba’zi havolalar ko‘proq vaqt olishi mumkin.",
        "extract_failed": (
        ...
        "formats_video_header": "Video formatlar:",
        "formats_audio_header": "Audio:",
        "audio_only": "Bu havola uchun faqat audio mavjud.",
        "unknown": "Noma'lum",
        "expired_selection": "Bu tanlov muddati tugagan. Havolani qayta yuboring.",
        "original_link_not_found": "Asl havola yozilgan xabar topilmadi. Havolani qayta yuboring.",
        "no_url_found": "Xabarda to‘g‘ri havola topilmadi.",
        "send_link_example": "Masalan: {example}",
        "rate_limit_exceeded": (
            "Limit oshdi. Bir daqiqada eng ko'pi bilan 5 ta yuklab olish mumkin."
        ),
        "rate_limit_exceeded_wait": "Limit oshdi. Taxminan {seconds}s kuting va qayta urinib ko‘ring.",
        ...
        "done_ready": "✅ Tayyor. Istalgan payt yana havola yuboring.",
        "audio_mp3": "Audio (MP3)",
        "best_quality": "⭐ Eng yaxshisi (tavsiya)",
    ...
    "ru": {
        ...
        "analyzing_link_slow": "Все еще работаю… некоторые ссылки могут обрабатываться дольше.",
        "extract_failed": (
        ...
        "formats_video_header": "Видео форматы:",
        "formats_audio_header": "Аудио:",
        ...
        "original_link_not_found": "Не вижу исходное сообщение со ссылкой. Отправьте ссылку еще раз.",
        "no_url_found": "В сообщении не найдена корректная ссылка.",
        "send_link_example": "Пример: {example}",
        "rate_limit_exceeded": "Превышен лимит. Максимум 5 загрузок в минуту.",
        "rate_limit_exceeded_wait": "Превышен лимит. Подождите примерно {seconds}s и попробуйте снова.",
        ...
        "done_ready": "✅ Готово. Можете отправить следующую ссылку.",
        "audio_mp3": "Audio (MP3)",
        "best_quality": "⭐ Лучшее (рекомендуется)",
